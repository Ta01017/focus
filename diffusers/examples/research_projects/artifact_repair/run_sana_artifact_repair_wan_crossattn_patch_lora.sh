...
OUTPUT_DIR=${OUTPUT_DIR:-/data/vjuicefs_ai_camera_3drg_ql/public_data/11188633/focus/models/train/sana_artifact_repair/route3_wan_crossattn_patch_lora}
...
echo "[ROUTE3 PATCH_LORA] MODEL=${MODEL}"
echo "[ROUTE3 PATCH_LORA] IMAGE_ENCODER_MODEL=${IMAGE_ENCODER_MODEL}"
echo "[ROUTE3 PATCH_LORA] DATASET_BASE_PATH=${DATASET_BASE_PATH}"
echo "[ROUTE3 PATCH_LORA] DATASET_METADATA_PATH=${DATASET_METADATA_PATH}"
echo "[ROUTE3 PATCH_LORA] OUTPUT_DIR=${OUTPUT_DIR}"
echo "[ROUTE3 PATCH_LORA] TRAIN_MODE=${TRAIN_MODE}"
echo "[ROUTE3 PATCH_LORA] MIXED_PRECISION=${MIXED_PRECISION}"
echo "[ROUTE3 PATCH_LORA] LORA_RANK=${LORA_RANK}"
echo "[ROUTE3 PATCH_LORA] LORA_ALPHA=${LORA_ALPHA}"
echo "[ROUTE3 PATCH_LORA] LORA_SCOPE=${LORA_SCOPE}"
echo "[ROUTE3 PATCH_LORA] INIT_FROM_ROUTE2_CHECKPOINT=${INIT_FROM_ROUTE2_CHECKPOINT}"
echo "[ROUTE3 PATCH_LORA] RESUME_FROM_CHECKPOINT=${RESUME_FROM_CHECKPOINT}"
