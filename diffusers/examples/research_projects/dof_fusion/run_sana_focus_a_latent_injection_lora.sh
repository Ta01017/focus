...
OUTPUT_DIR=${OUTPUT_DIR:-/data/vjuicefs_ai_camera_3drg_ql/public_data/11193880/focus/models/train/sana_focus_latent_injection/a_only}
...
echo "[FOCUS_ROUTE1_A] MODE=${MODE}"
echo "[FOCUS_ROUTE1_A] CONDITION_MODE=${CONDITION_MODE}"
echo "[FOCUS_ROUTE1_A] TRAIN_BASE=${TRAIN_BASE}"
echo "[FOCUS_ROUTE1_A] TRAIN_META=${TRAIN_META}"
echo "[FOCUS_ROUTE1_A] OUTPUT_DIR=${OUTPUT_DIR}"
echo "[FOCUS_ROUTE1_A] CHECKPOINT=${CHECKPOINT}"
